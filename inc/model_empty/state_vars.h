...
/*  The variables that identify a unique state in our model are defined here.
    They are the variables that will become available in the AbstractIterator and
    AbstractState classes as a state_variable object
    See inc/aux.h for how to access them
*/

/*  Every state of the model is identified by the values for the variables below */
